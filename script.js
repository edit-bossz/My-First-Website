...
if (window.innerWidth <= 768) {
    document.getElementById("contact-link").setAttribute("href", "intent://send?to=editprime7@gmail.com&subject=Subject&body=Body#Intent;scheme=mailto;package=com.google.android.gm;end");
} else {
    document.getElementById("contact-link").setAttribute("href", "https://mail.google.com/mail/?view=cm&fs=1&to=editprime7@gmail.com");
}